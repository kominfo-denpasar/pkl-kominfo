...
<![endif]-->
    ...
    $.ajax({    
        type: "GET",
        url: "aksihapusbarang.php", 
        data:{deleteId:id},            
        dataType: "html",                  
        success: function(data){   

        $('#msg').html(data);
       $('.delete-row').load('aksihapusbarang.php');
      ...
      $(function(){
        ...
        $.ajax({
          ...
          success: function(data){
            ...
            $('.tabel2').load("tampildatabarang.php");
// var sum = data.reduce(function (total, currentValue) {
//     return total + currentValue.harga;
// }, 0);
            $('.prabiaya').val(sum);
          },
          error: function(data){
    ...
    $(document).ready(function(){
        ...
        $(".delete-row").click(function(){
            $(".tabel1").find('input[name="record"]').each(function(){
                if($(this).is(":checked")){
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="namakld" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="ppk" >
                                                </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="kodebmn" >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-4 col-form-label">Nama BMN/Persediaan</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="namabmn" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" name="kegunaan" rows="3"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="tglpemakaian" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="estimasiwaktu" >
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <form  method="post" class="form-tenagaahli">
                                                            <input type="text" id="nama_ahli" name="nama_ahli" placeholder="Nama Tenaga Ahli">
                                                            <input type="text" id="tugas_ahli" name="tugas_ahli" placeholder="Tugas">
                                                       
                                                            <button type="button" class="add-row-tenagaahli"> Add Row</button> 
                                                    </form>

                                                    <div class="tampildataahli"> </div>
                                                    <button type="button" class="delete-row">Delete Row</button> <br><br>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="layakpakai" >
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="rusakringan" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="rusakberat" >
                                                </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="carakirim" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="carapasang" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="carasimpan" >
                                                </div>
                                            </div>
